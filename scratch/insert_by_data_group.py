...
diagrams_map = {
    "CS.TTBYT.04": ("SƠ ĐỒ QUY TRÌNH KIỂM ĐỊNH & HIỆU CHUẨN THIẾT BỊ Y TẾ (CS.TTBYT.04)", """
graph LR
...
"""),
    "TA5.TTBYT.QT.01": ("SƠ ĐỒ KIỂM SOÁT CHẤT LƯỢNG NƯỚC R.O THẬN NHÂN TẠO (QT.01)", """
graph TD
...
"""),
    "TA5.TTBYT.QT.02": ("SƠ ĐỒ VẬN HÀNH HỆ THỐNG R.O THẬN NHÂN TẠO (QT.02)", """
graph LR
...
"""),
    "TA5.TTBYT.QT.03": ("SƠ ĐỒ VẬN HÀNH & KIỂM TRA HỆ THỐNG KHÍ Y TẾ TRUNG TÂM (QT.03)", """
graph TD
...
"""),
    "TA5.TTBYT.QT.04": ("SƠ ĐỒ BÀN GIAO, LẮP ĐẶT & NGHIỆM THU ĐƯA VÀO SỬ DỤNG (QT.04)", """
graph LR
...
"""),
    "TA5.TTBYT.QT.05": ("SƠ ĐỒ VẬN HÀNH & BẢO QUẢN THIẾT BỊ TẠI KHOA PHÒNG (QT.05)", """
graph TD
...
"""),
    "TA5.TTBYT.QT.06": ("SƠ ĐỒ BẢO TRÌ ĐỊNH KỲ (PM) & SỬA CHỮA BÁO HỎNG SPEEDMAINT (QT.06)", """
graph LR
...
"""),
    "TA5.TTBYT.QT.07": ("SƠ ĐỒ QUY TRÌNH THANH LÝ THIẾT BỊ Y TẾ (QT.07)", """
graph LR
...
"""),
    "TA5.TTBYT.QT.08": ("SƠ ĐỒ ĐIỀU CHUYỂN THIẾT BỊ GIỮA CÁC KHOA PHÒNG (QT.08)", """
graph LR
...
"""),
    "TA5.TTBYT.QT.09": ("SƠ ĐỒ GIAO NHẬN BÌNH KHÍ Y TẾ DI ĐỘNG (QT.09)", """
graph LR
...
for group_code, (title, mm_code) in diagrams_map.items():
    section = soup.find('section', attrs={'data-group': group_code})
    if section:
        ...
        if block_head:
            ...
            print(f"✅ Injected visual diagram for [{group_code}]")
