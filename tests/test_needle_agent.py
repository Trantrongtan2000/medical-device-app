"""
Tests for Needle Edge Agent & Cactus Hybrid Router POC
"""
import pytest
...
def test_router_facility_lookup():
    decision = NeedleRouter.parse_intent("Tra cứu thông tin Khoa Cấp Cứu")
    assert decision.route == "LOCAL_EDGE"
...
# 2. Integration Tests with SafeToolExecutor
